...
class TestSmokeTest():
  ...
  def test_test1(self):
    ...
    self.driver.set_window_size(1149, 765)
  ...
  def test_test4(self):
    ...
    self.driver.find_element(By.NAME, "fname").send_keys("Isabella")
    ...
    self.driver.find_element(By.NAME, "bizname").send_keys("Isa Business")
